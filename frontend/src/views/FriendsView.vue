...
const onSearchInput = () => {
  ...
  if (!q) {
    searchResults.value = allUsersCache.value.filter(u => u.isFriend || u.isPending)
        .sort((a, b) => {
            ...
            <ul class="list-group list-group-flush">
              <li v-for="req in pendingRequests" :key="req.sender_email" class="list-group-item d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center gap-2" style="min-width: 0;">
                  <img :src="req.avatar" alt="" class="rounded-circle flex-shrink-0" style="width: 40px; height: 40px; object-fit: cover; border: 1px solid #eee" @error="$event.target.src='/default-avatar.jpg'">
                  <div class="flex-grow-1" style="min-width: 0;">
